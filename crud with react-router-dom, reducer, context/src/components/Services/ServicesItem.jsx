...
function ServicesItem(props) {
  ...
  let {servicesState, servicesDispatch,bagDispatch} = useContext(MyContext)
  
  function handleDelete() {
    servicesDispatch({type:'DELETE FROM SERVICES', payload: props.obj.id})
  }

  function addToBag() {
    bagDispatch({type:'ADD TO BAG', payload: props.obj})
  }
